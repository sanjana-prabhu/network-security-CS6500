...
- 3 Python scripts, kdc.py, client.py and utils.py
- 3 typescript files, kdcscript, sendscript and recvscript
- 3 sample text files*, in.txt(containing the input message), pwd.txt(containing the passwords/client details), output.txt(containing KDC log of a sample session given below)

* you can empty the pwd.txt and output.txt files and modify the in.txt file(<660 bytes) before testing. These files have been submitted only for demonstrating the format of the pwdfile and outputfile.
